...
Uso:
    ...
    python examples/run_overnight.py --workers 8 --skip br_all kp_all
"""
...
def phases(workers: int, smoke: bool, time_limit: int = 10):
    ...
    if smoke:   # collaudo rapido della catena (~1 minuto)
        return [
            ...
            ("kp_all", [PY, HERE / "run_campaign.py", "--sets", "okp",
...
def main() -> None:
    ...
    ap.add_argument("--skip", nargs="*", default=[],
                    choices=["br_all", "kp_all", "ngcutfs", "xlsx"],
